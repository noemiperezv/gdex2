...
check('email').isEmail().withMessage('Email: No se ingreso un correo valido').trim().not().isEmpty().withMessage('Email: El campo esta vacio').isLength({min: 8}).withMessage('Email: Minimo 8 caracteres'),
